  ...
  return (
    ...
    >
      ...
      <a 
        ...
        className="text-lime-900 dark:text-lime-100 flex items-center hover:text-xl border-lime-900 border-2 rounded-[26px] mt-6"
      >
        <span className="m-3">Download CV</span>
        <HiDownload className="bg-lime-900 text-green-200 w-14 h-12 p-2 rounded-r-[26px] right-[-5px]"/>
      </a>
      <div className="flex flex-col justify-around items-center w-fit h-60 fixed top-20 right-3 z-10 py-3">
        <a 
          ...
          target='_blank' 
          className="bg-lime-950 text-white hover:bg-green-900 hover:text-lime-100 rounded-full"
        >
          <FaGithub className="w-10 h-10 p-1 rounded-full" />
        </a>
        <a
        ...
        >
          <IoLogoLinkedin className="w-11 h-11" />
        </a>
        <a 
